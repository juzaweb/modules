...
interface HookActionContract
{
     ...
     * e.g. \App\Models\Post::class (defaults to the Post model).
     ...
     * @param  bool  $inFooter  Determines whether the script tags will be added at the end of the HTML (in footer)
     * or not.
     *
     * @return void
     */
    ...
    /**
     * Retrieves the network configurations.
     *
     * @param string|null $key The key of the configuration to retrieve. If null, retrieves all configurations.
     * @return Collection The collection of network configurations.
     */
    public function getNetworkConfigs(string|null $key = null): Collection;

    /**
     * Registers a network setting page.
     *
     * @param  string  $key  The unique key for the setting page.
     * @param  array  $args  An optional array of arguments.
     *                    - 'label' (string): The label for the setting page.
     *                    - 'menu' (array): An array of menu options.
     *                                      - 'icon' (string): The icon for the menu item.
     *                                      - 'parent' (string): The parent menu item.
     * @return void
     */
    public function registerNetworkSettingPage(string $key, array $args = []): void;

    /**
     * Adds a network setting form.
     *
     * @param  string  $key  The key of the network setting form.
     * @param  array  $args  An array of arguments to customize the network setting form.
     *   - name (string): The name of the network setting form.
     *   - key (string): The key of the network setting form.
     *   - view (null): The view of the network setting form.
     *   - header (bool): Whether to display the header of the network setting form.
     *   - footer (bool): Whether to display the footer of the network setting form.
     *   - priority (int): The priority of the network setting form.
     *   - page (string): The page of the network setting form.
     * @return void
     */
