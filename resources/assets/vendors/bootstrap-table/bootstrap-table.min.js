              ...
              key: 'initHeader', value: function () {
                  ...
                  this.header = {
                      ...
                      o.push('<tr>'), 0 === n && !t.options.cardView && t.options.detailView && o.push('<th class="detail" rowspan="' + t.options.columns.length + '">\n            <div class="fht-cell"></div>\n            </th>\n          '), a.forEach(function (a, i) {
                          ...
                          var u = s;
                          a.checkbox && (s = '', !t.options.singleSelect && t.options.checkboxHeader && (s = '<label class="jw__utils__control jw__utils__control__checkbox"><input name="btSelectAll" type="checkbox" /><span class="jw__utils__control__indicator"></span></label>'), t.header.stateField = a.field), a.radio && (s = '', t.header.stateField = a.field, t.options.singleSelect = !0), !s && a.showSelectTitle && (s += u), o.push(s), o.push('</div>'), o.push('<div class="fht-cell"></div>'), o.push('</div>'), o.push('</th>');
                      }), o.push('</tr>');
